        ...
        <section suppressHydrationWarning>
            <div className="bg-trans-blue w-full relative z-1 pt-[50px] lg:pt-[85px]">
                <div className="max-container">
                    ...
                    <div className="callout-section bg-white shadow-[0_0_10px_0_rgb(1 131 179 / 10%)] rounded-[18px] p-[30px] md:px-[40px] lg:px-[80px] py-[40px] flex flex-wrap">
                        ...
                        <div className="text text-center w-full sm:w-[calc(100%-68px)] pt-[10px] sm:pt-0 pl-0 sm:pl-[20px] md:pl-[40px] text-blue font-medium">
                            <p className="p4">
