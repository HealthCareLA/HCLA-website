...
export default function MemberPatientPlanResource(block) {
  ...
  return (
    <section id="Health_Plans_Resources" className="pt-[50px] md:pt-[80px] lg:pt-[100px] pb-[50px] md:pb-[80px] lg:pb-[150px]" suppressHydrationWarning  style={{ scrollMarginTop: '100px' }}>
      <div className="max-container">
        <div className="plans-resources grid grid-cols-1 lg:grid-cols-2 gap-[50px] lg:gap-[70px]">
          <div className="health-plans">
            ...
            <p className="p1 font-normal text-common-clr text-common-clr mb-[40px]">{block.healthPlans.description}</p>
            {block.healthPlans.links?.length > 0 && (
              <ul className="">
                {block.resources.links.map(link => (
                  <li className="flex flex-col justify-start py-[20px] border-t-[1px] border-[#B3E1F2]">
          ...
          <div className="helpful-resources">
            ...
            <p className="p1 font-normal text-common-clr text-common-clr mb-[40px]">{block.resources.description}</p>
            ...
            {block.resources.buttonlinks?.length > 0 && (
              <ul className="border-b-[1px] border-[#B3E1F2]">
                {block.resources.buttonlinks.map(link => (
                  <li className="flex items-center py-[20px] border-t-[1px] border-[#B3E1F2]">
                    <a href={link.url} className="p2 font-medium text-blue hover:text-green inline-block">
                      {link.text}
                      <i className="fa-solid fa-circle-chevron-right text-green ml-1"></i>
                    </a>
