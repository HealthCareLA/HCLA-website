...
export default function OurImpactCollaborataction(block) {
  return (
    <section className="bg-trans-blue pb-[120px]" suppressHydrationWarning>
      <div className="max-container">
        <div className="bg-white py-[30px] lg:py-[0] px-5 lg::p-[30px] xl:p-[50px] xxl:p-20 rounded-[18px]">

          {
            block.title && (
              <h2 className="text-[32px] lg:text-[42px] text-center font-medium text-blue mb-[50px] xl:mb-[70px]">{block.title}</h2>
            )
          }
