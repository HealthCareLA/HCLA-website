...
export default function WhoWeAreHealthcare({
  title,
  description,
  description2,
  buttonText,
  ...
  return (
    <section className={isMatch ? "bg-sky-blue text-blue py-20 md:py-20 lg:pb-[100px]" : "bg-blue text-white py-20 md:py-20 lg:pt-[120px] lg:pb-[25px]"} suppressHydrationWarning
      id="Why_HCLA" >
        ...
        <div className="flex flex-col-reverse lg:flex-row items-start justify-between gap-[50px]">
          <div className="mx-auto lg:w-1/2 relative">
            <img
              ...
              width={image?.width}
              height={image?.height}
              className={`object-cover ${image?.isRound ? 'rounded-full mx-auto max-w-[280px] md:max-w-80 xl:max-w-[480px] max-h-[280px] md:max-h-80 xl:max-h-[480px]' : 'rounded-[40px]'}`}
            />
            <img
