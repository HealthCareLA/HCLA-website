            ...
            <section className="py-[50px] lg:pt-[250px] xl:pt-[300px] lg:pb-[100px] xl:pb-[175px] bg-[#EEFCFF]" suppressHydrationWarning>
                <div className="max-container mx-auto px-6">
                    ...
                    {block.sections.map((section) => (
                        <div className="mt-10 lg:mt-[75px] first-of-type:mt-0 bg-white rounded-[18px] lg:py-[60px] py-10 px-5 shadow-[0px_0px_10px_0px_#0183B31A]">
                            <h3 className="text-center font-medium lg:mb-[35px] mb-5 text-[#0183B3]">{section.title}</h3>
